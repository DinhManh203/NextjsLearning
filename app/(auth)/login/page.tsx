    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center px-6 py-8">
            <div className="w-[780px] p-[40px] bg-white rounded-[16px] shadow-lg ">
                <div className=''>
                    {networkError && (
                        <div className="absolute top-[130px] left-1/2 transform -translate-x-1/2 bg-red-500 text-white px-6 py-[2px] flex items-center justify-center w-[780px] rounded-t-lg z-50">
                            <Image
                    ...
                    {loginError && (
                        <div className="absolute lg:top-[130px] md:top-[130px] sm:top-[130px] xsm:top-[135px] left-1/2 transform -translate-x-1/2 bg-red-500 text-white px-6 py-[2px] flex items-center justify-center lg:w-[780px] md:w-[780px] sm:w-[540px] xsm:w-[310px] rounded-t-lg z-50">
                            <Image
                    ...
                    {loginSuccess && (
                        <div className="absolute top-[130px] left-1/2 transform -translate-x-1/2 bg-green-500 text-white px-6 py-[2px] flex items-center justify-center w-[780px] rounded-t-lg z-50">
                    ...
                    <div className="col-span-3 mt-[45px]">
                        <div className="">
                            ...
                            <input
                                ...
                                name="email"
                                id="email"
                                className={`bg-[#f5f7fa] border ${errors.email ? 'border-red-500' : 'border-gray-300'
                        ...
                        <div className="mt-[10px]">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    name="password"
                                    id="password"
                                    className={`bg-[#f5f7fa] border ${errors.password ? 'border-red-500' : 'border-gray-300'
                                        } text-gray-900 rounded-lg focus:ring-[#C025F4] focus:border-[#C025F4] block w-full h-[40px] px-[8px]`}
